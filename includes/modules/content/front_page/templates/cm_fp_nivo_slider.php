<?php
/*
  $Id: cm_fp_nivo_slider.php, v2.0 20160518 - f.figue$
...
<!-- Start cm_fp_nivo_slider module -->
<div class="contentContainer">
  <div id="nivo_slider" class="col-sm-<?php echo MODULE_CONTENT_FRONT_PAGE_NIVO_SLIDER_CONTENT_WIDTH; ?>">
  
        <div class="slider-wrapper theme-default">
          <div id="sliderfront" class="nivoSlider">
<?php
	  $data = '';
      $slides_cnt = 0;
	  ...
	  // Añado la descripcion si se elije con caption
	   $slides_caption = ((MODULE_CONTENT_FRONT_PAGE_NIVO_SLIDER_CAPTION == 'true') ? $slideshow['slides_description'] : '');
	  // Abro la imagen
