...
*/
  ...
  class cm_nb_generic {
    ...
    public function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_NAVBAR_GENERIC_SORT_ORDER', '9190', 'Sort order of display. Lowest is displayed first.', '6', '2', now())");
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Link', 'MODULE_CONTENT_NAVBAR_GENERIC_LINK', 'index.php', 'The osCommerce filename if internal, otherwise the full URL.', '6', '5', now())");
    }
