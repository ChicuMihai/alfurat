...
<!-- Start cm_i_nivo_slider module -->
<div class="contentContainer">
  <div id="nivo_slider" class="col-sm-<?php echo MODULE_CONTENT_INDEX_NIVO_SLIDER_CONTENT_WIDTH; ?>">
...
<?php
	  ...
	  // Añado la descripcion si se elije con caption
	   $slides_caption = ((MODULE_CONTENT_INDEX_NIVO_SLIDER_CAPTION == 'true') ? $slideshow['slides_description'] : '');
	  // Abro la imagen
